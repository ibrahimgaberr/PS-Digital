    ...
    <>
      <header className="bg-white dark:bg-gray-900">
        <div className="container flex flex-col px-6 py-10 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
          ...
          <div className="flex items-center justify-center w-full h-96 lg:w-1/2 rounded-tr-[40px] rounded-bl-[40px]">
            <iframe
              className="border-none"
              src="https://player.vimeo.com/video/796024124?dnt=1&amp;app_id=122963&amp;controls=0&amp;loop=1&amp;dtn=1"
              width="624"
              height="390"
